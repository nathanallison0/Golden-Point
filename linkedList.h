...
#define __linked_list_destroy_all_head__(typename) \
void typename##_destroy_all(typename *head) { \
    typename *temp = head; \
    typename *next; \
    while (temp) { \
        next = temp->next; \
...
#define __doubly_linked_list_head__(typename) typename *typename##_head = NULL;
...
#define __doubly_linked_list_creator__(typename, creator_arguments, set_attrs) \
...
#define __doubly_linked_list_all__(typename, attributes, creator_arguments, creator_set_attrs, destroyer_code) \
__doubly_linked_list_init__(typename, attributes) \
__doubly_linked_list_creator__(typename, creator_arguments, creator_set_attrs) \
__doubly_linked_list_destroyer__(typename, destroyer_code) \
__linked_list_destroy_all_head__(typename)

#define __doubly_linked_list_all_add__(typename, attributes, creator_arguments, creator_set_attrs, destroyer_code) \
__doubly_linked_list_init__(typename, attributes) \
__doubly_linked_list_head__(typename) \
